...
Date: 2012-02-20 10:31:29
*/

SET FOREIGN_KEY_CHECKS=0;
-- ----------------------------
-- Table structure for `bs_configs`
-- ----------------------------
DROP TABLE IF EXISTS `bs_configs`;
CREATE TABLE `bs_configs` (
  `id` int(25) NOT NULL AUTO_INCREMENT,
  `bs_config_name` varchar(255) NOT NULL,
  `bs_config_value` varchar(255) NOT NULL,
  `bs_config_value_secondary` text,
  `bs_config_value_tertiary` text,
  `bs_config_value_quaternary` text,
  `bs_config_active` int(2) NOT NULL DEFAULT '1',
  `bs_config_description` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of bs_configs
-- ----------------------------
INSERT INTO bs_configs VALUES ('1', 'on_developing_games', 'mists', 'Oculta por la niebla durante miles de años, Pandaria no ha sido tocada por la guerra. ¿Revelará la bruma la salvación del mundo? ¿O habrá un nuevo conflicto donde la Alianza y la Horda pasen del borde a la aniquilación total?', 'site/mists', null, '1', 'Configuración para los juegos en desarrollo. El valor corresponderá al nombre del módulo que cargará.');
INSERT INTO bs_configs VALUES ('2', 'on_developing_games', 'sc2-hots', 'Sin su reina para guiarlo y unificarlo, el Enjambre se fragmentó en diversas nidadas por todo el Sector Koprulu. Una de las más grandes amenazas para la galaxia ha sido neutralizada… o al menos así parece.', 'site/sc2-hots', null, '1', 'Configuración para los juegos en desarrollo. El valor corresponderá al nombre del módulo que cargará.');
INSERT INTO bs_configs VALUES ('3', 'on_developing_games', 'd3', 'Hace dos décadas, Diablo, Mefisto y Baal sembraron destrucción en el mundo. Los recuerdos de quienes los enfrentaron, sin embargo, se disipan con lentitud.', 'site/d3', null, '1', 'Configuración para los juegos en desarrollo. El valor corresponderá al nombre del módulo que cargará.');
INSERT INTO bs_configs VALUES ('4', 'actual_games', 'cataclysm', null, 'site/cataclysm', null, '1', 'Configuración para los juegos actuales.');
INSERT INTO bs_configs VALUES ('5', 'actual_games', 'sc2', null, 'site/sc2', null, '1', 'Configuración para los juegos actuales.');
INSERT INTO bs_configs VALUES ('6', 'actual_games', 'wrath', null, 'site/wrath', null, '1', 'Configuración para los juegos actuales.');
INSERT INTO bs_configs VALUES ('7', 'actual_games', 'bc', null, 'site/bc', null, '1', 'Configuración para los juegos actuales.');
INSERT INTO bs_configs VALUES ('8', 'actual_games', 'wow', null, 'site/wow', null, '1', 'Configuración para los juegos actuales.');
INSERT INTO bs_configs VALUES ('9', 'actual_games', 'war3', null, 'site/war3', null, '1', 'Configuración para los juegos actuales.');
INSERT INTO bs_configs VALUES ('10', 'actual_games', 'd2', null, 'site/d2', null, '1', 'Configuración para los juegos actuales.');
INSERT INTO bs_configs VALUES ('11', 'actual_games', 'sc1', null, 'site/sc1', null, '1', 'Configruación para los juegos actuales.');
INSERT INTO bs_configs VALUES ('12', 'actual_games', 'legacy', null, 'site/legacy', null, '1', 'Configuración para los juegos actuales.');
